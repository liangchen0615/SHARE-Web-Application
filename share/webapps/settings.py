...
#SECRET_KEY = 'django-insecure-k_=8s_zfo9mleo1w=ov=o0h($f4ue@w8-3o=ttyd$1zoue5+hh'
SECRET_KEY = CONFIG.get("Django", "Secret")

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['localhost', 'webapp.andrew.cmu.edu', 'demo.cmu-webapps.org', '127.0.0.1', '3.101.89.191','http://127.0.0.1:8000']
